        ...
        <section class="hero bg-image" data-image-src="images/img/main.jpeg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Foodie......</h1>
                    <h5 class="font-white space-xs">Find the Best Restaurants and Dishesh</h5>
                    <div class="banner-form">
                        <form class="form-inline" action="#serch" method="get">
                            <div class="form-group">
                                <label class="sr-only" for="exampleInputAmount">I would like to eat....</label>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" id="exampleInputAmount" name="exampleInputAmount" placeholder="I would like to eat...."> 
                    ...
                    <!-- <section id="serch" style="background-color:black">
                        HTML
                        </section> -->
                    <div class="steps">
            ...
            <div class="container">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <!-- <p>We've got your covered with menus from over 100 delivery restaurants online.</p> -->
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">Pay Cash on delivery / Online</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row top-footer">
                    ...
                    <div class="col-xs-12 col-sm-3 popular-locations color-gray">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Nigdi</a> </li>
                            <li><a href="#">Bhosari</a> </li>
                        </ul>
                    </div>
                </div>
                <!-- top footer ends -->
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            ...
                            <!-- <h5>Phone: <a href="tel:1234567890">1234567890</a></h5> </div> -->
                    </div>
                    <div><h5>Phone:</h5><h5>+919934567890</h5></div>
                </div>
                <!-- bottom footer ends -->
            </div>
        </footer>
